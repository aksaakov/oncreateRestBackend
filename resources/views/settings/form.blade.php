...
@section('content')
    <form method="post" action="@if ($item->id == null) {{ route('settings.store') }} @else {{ route('settings.update', ['id' => $item->id]) }} @endif" enctype="multipart/form-data">
        ...
        <ul class="nav nav-tabs" role="tablist">
            ...
            <li role="presentation">
                <a href="#loyalty" aria-controls="profile" role="tab" data-toggle="tab">{{ __('messages.settings.loyalty') }}</a>
            </li>
        </ul>
        ...
        <div class="tab-content">
            ...
            <div role="tabpanel" class="tab-pane" id="loyalty">
                <br>
                <div class="form-group {{ $errors->has('loyalty_points_per_amount') ? ' has-error' : '' }}">
                    <label for="" class="control-label">{{ __('messages.settings.f_loyalty_points_per_amount') }}</label>
                    <input type="text" class="form-control" value="{{$item->loyalty_points_per_amount}}" name="loyalty_points_per_amount"/>
                    @if ($errors->has('loyalty_points_per_amount'))
                        <span class="help-block">
                        <strong>{{ $errors->first('loyalty_points_per_amount') }}</strong>
                    </span>
                    @endif
                </div>
                <div class="form-group {{ $errors->has('loyalty_points_per_order') ? ' has-error' : '' }}">
                    <label for="" class="control-label">{{ __('messages.settings.f_loyalty_points_per_order') }}</label>
                    <input type="text" class="form-control" value="{{$item->loyalty_points_per_order}}" name="loyalty_points_per_order"/>
                    @if ($errors->has('loyalty_points_per_order'))
                        <span class="help-block">
                        <strong>{{ $errors->first('loyalty_points_per_order') }}</strong>
                    </span>
                    @endif
                </div>
                <div class="form-group {{ $errors->has('loyalty_points_for_reward') ? ' has-error' : '' }}">
                    <label for="" class="control-label">{{ __('messages.settings.f_loyalty_points_for_reward') }}</label>
                    <input type="text" class="form-control" value="{{$item->loyalty_points_for_reward}}" name="loyalty_points_for_reward"/>
                    @if ($errors->has('loyalty_points_for_reward'))
                        <span class="help-block">
                        <strong>{{ $errors->first('loyalty_points_for_reward') }}</strong>
                    </span>
                    @endif
                </div>
                <div class="form-group {{ $errors->has('loyalty_reward_amount') ? ' has-error' : '' }}">
                    <label for="" class="control-label">{{ __('messages.settings.f_loyalty_reward_amount') }}</label>
                    <input type="text" class="form-control" value="{{$item->loyalty_reward_amount}}" name="loyalty_reward_amount"/>
                    @if ($errors->has('loyalty_reward_amount'))
                        <span class="help-block">
                        <strong>{{ $errors->first('loyalty_reward_amount') }}</strong>
                    </span>
                    @endif
                </div>
            </div>
