...
class OrdersService
{
	...
	public function getValidator($data)
    {
        ...
        $messages = [
            'customer_id.required' => 'It seems that require client signup setting is set, however first app run was done with this setting disabled. Please completely restart the app.'
        ];
        if (Settings::getSettings()->signup_required) {
